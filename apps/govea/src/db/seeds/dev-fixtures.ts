...
export const GOVEA_PROJECT_PRINCIPLES = [
  {
    name: 'People-Centered Architecture',
    description: 'Start every architecture conversation with the people it affects — personas first, systems second.',
  ...
  {
    name: 'Plain Language over Framework Compliance',
    description: 'Use plain language that non-specialist government staff can understand, even when a recognised framework provides a more precise but less accessible term.',
    title: 'Prefer plain language over framework jargon',
    rationale: 'The primary users of GovEA are government professionals with domain expertise but without formal EA training. Framework compliance is valuable, but not at the cost of usability. A practitioner who can\'t describe a capability in plain language probably doesn\'t understand it well enough to model it accurately.',
    implications: 'Core GovEA terminology (capability, persona, value stream, principle, ADR) is defined in plain English in the glossary and on-screen help text. TOGAF, Zachman, and FEAF mappings are documented in the optional overlay, not the default interface. New terminology must pass a plain-language review before it is added to the UI.',
    principleType: 'data' as const,
    status: 'published' as const,
    visibility: 'connections' as const,
    capabilities: ['Content Authoring & Workflow', 'Feature Management'],
